...
<span class="text-muted">Lihat Produk
       ...
       <div class="col-md-8 order-md-1">
          <form method="post" id="tabelorder" action="proses/eksekusiorder.php">
            <div class="row">
            ...
            <div class="mb-3">
              <label for="logoprodukta">Logo Produk</label>
              <div class="input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text">#</span>
                </div>
                <input type="file" class="form-control" name="logoprodukta" id="logoprodukta" placeholder="upload logo" required="">
...
<div class="mb-3">
              <label for="gambarunggulanta">Gambar banner produk</label>
              <div class="input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text">#</span>
                </div>
                <input type="file" class="form-control" name="gambarunggulanta" id="gambarunggulanta" placeholder="upload gambar unggulan" required="">
                <div class="invalid-feedback" style="width: 100%;">
                  Harus upload gambar unggulan.
                </div>
              </div>
            </div>
