...
{
  $logo = basename($_FILES['logoprodukta']['name']);

  if (move_uploaded_file($_FILES['logoprodukta']['tmp_name'], $logo)) {

    $queryku_update = "UPDATE produkta SET logoprodukta='$logo' WHERE namaprodukta = '$namaprodukta' AND hargaprodukta = '$hargaprodukta'";
