...
{
  $gambarta = $namafolder . basename($_FILES['gbunggulanta']['name']);

  if (move_uploaded_file($_FILES['gbunggulanta']['tmp_name'], $gambarta)) {

    $queryku_update = "UPDATE produkta SET gambarunggulanta='$gambarta' namaprodukta='$namaprodukta', uraianprodukta='$uraianprodukta', unggulprodukta='$unggulprodukta', fiturprodukta='$fiturprodukta',hargaprodukta='$hargaprodukta', promo='$promo' WHERE idprodukta='$idprodukta'";
    ...
    $update = mysqli_query($conn,$queryku_update)or die(mysqli_error());
      ...
      <br/><center><h3><span class='label'>berhasil disimpan... </span></h3><br/><br/>
             ...
             <div class='btn btn-outline-primary' href='inputproduk.php'>Tambah Produk</div>
             <div class='btn btn-outline-primary' href='index.php'>Beranda</div>
      <div class='container'>         
